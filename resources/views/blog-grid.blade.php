            ...
            <div class="container">
                <div class="row justify-content-center">
                        ...
                        <div class="blog">
                            <div class="blog-image">
                                <a href="{{url('blog-details')}}">
                                    <img class="img-fluid" src="{{URL::asset('./build/img/blog/blog-16.jpg')}}" alt="img">
                                </a>
                            </div>
                            <div class="blog-item">
                    ...
                    <div class="col-lg-9">
                        <div class="blog">
                            <div class="blog-image">
                                <a href="{{url('blog-details')}}">
                                    <img class="img-fluid" src="{{URL::asset('./build/img/blog/blog-17.jpg')}}" alt="img">
                                </a>
                            </div>
                            <div class="blog-item">
                                ...
                                <div class="blog-info">
                                    <div class="d-flex align-items-center flex-wrap justify-content-between gap-2">
                                        <div class="d-flex align-items-center user-profile">
                                            <a href="{{url('instructor-details')}}" class="user-img"><img class="rounded-pill w-auto" src="{{URL::asset('./build/img/user/user-15.jpg')}}" alt="img"></a>
                ...
                <div class="col-lg-9">
                    <div class="blog">
                        <div class="blog-image">
                            <a href="{{url('blog-details')}}">
                                <img class="img-fluid" src="{{URL::asset('./build/img/blog/blog-18.jpg')}}" alt="img">
                            </a>
                        </div>
                        <div class="blog-item">
