                ...
                <div class="col-lg-9">
                    <div class="mb-3">
                        ...
                        <ul class="settings-nav d-flex align-items-center flex-wrap border bg-light-900 rounded">
                            <li><a href="{{url('instructor-settings')}}" class="active">Profile</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="profile-upload-group">									
                                <div class="d-flex align-items-center">
                                    <a href="{{url('student-profile')}}" class="avatar flex-shrink-0 avatar-xxxl avatar-rounded border me-3"><img src="{{URL::asset('build/img/user/user-01.jpg')}}" alt="Img" class="img-fluid"></a>
                                    <div class="profile-upload-head">
                                        <h6><a href="{{url('student-profile')}}">Your Avatar</a></h6>
